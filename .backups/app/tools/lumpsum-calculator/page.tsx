      ...
      <Container>
        ...
        <div className="max-w-3xl mb-12">
          ...
          <p className="text-base text-[var(--color-text-secondary)] mt-3 leading-relaxed">
            Estimate how a one-time capital deployment compounds over time. Understand the exponential
            advantage of holding quality assets undisturbed over multi-year cycles.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-14">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-40 pl-7 pr-3 py-1.5 text-right font-bold text-base text-[var(--color-primary)] bg-[var(--color-surface-canvas)] border border-[var(--color-border-subtle)] rounded-lg focus:outline-none focus:border-[var(--color-primary)]"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-24 px-3 py-1.5 text-right font-bold text-base text-[var(--color-text-primary)] bg-[var(--color-surface-canvas)] border border-[var(--color-border-subtle)] rounded-lg focus:outline-none focus:border-[var(--color-primary)]"
                    style={{ fontFamily: "var(--font-mono)" }}
                  />
          ...
          <div className="lg:col-span-5 bg-white p-7 md:p-8 rounded-2xl border border-[var(--color-border-subtle)] shadow-[var(--shadow-card-hover)] flex flex-col justify-between gap-6">
            <div>
              <div className="pb-4 border-b border-[var(--color-border-subtle)]">
                ...
                <p className="text-xs text-[var(--color-text-muted)] mt-1">
                  Approx. {formatINR(result.totalCorpus)} from {formatINR(principal)} over {years} years
                </p>
              </div>

              <div className="grid grid-cols-2 gap-3 my-5">
                <div className="p-3.5 rounded-xl bg-[var(--color-surface-canvas)] border border-[var(--color-border-subtle)]">
                  <span className="text-[11px] text-[var(--color-text-muted)] font-medium block">Initial Outlay</span>
              ...
              <div className="flex flex-col gap-1.5 mb-5">
                <div className="flex justify-between text-xs font-semibold text-[var(--color-text-muted)]">
                  <span>Initial Capital ({result.investedRatio}%)</span>
                  <span>Compounded Gain ({result.gainRatio}%)</span>
                </div>
                <div className="w-full h-3 rounded-full overflow-hidden flex bg-[var(--color-surface-low)]">
                  <div className="bg-[var(--color-primary)] h-full" style={{ width: `${result.investedRatio}%` }} />
                  <div className="bg-[var(--color-secondary)] h-full" style={{ width: `${result.gainRatio}%` }} />
                </div>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[var(--color-surface-canvas)] border border-[var(--color-border-subtle)] flex items-center justify-between text-xs font-medium text-[var(--color-text-secondary)]">
                ...
                <span className="font-bold text-[var(--color-secondary)]" style={{ fontFamily: "var(--font-mono)" }}>
                  {result.multiplier}× initial investment
                </span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-[var(--color-border-subtle)] flex flex-col gap-2.5">
              ...
              >
                <Phone size={13} />
                <span>Consult with Panchanan Kumar</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-white border border-[var(--color-border-subtle)] flex items-start gap-3 text-xs text-[var(--color-text-muted)]">
          ...
          <p className="leading-relaxed">
            <strong>Statutory Notice:</strong> Projections are purely illustrative based on user parameters and hypothetical compounding rates.
